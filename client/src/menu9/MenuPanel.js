...
class MenuPanel extends React.Component{
  ...
  render(){
    ...
    const backgroundValues = [
      {pathName: '/', isActive: hoverOption==='home', backgroundName: '/static/images/daytime.jpg'},
      ...
      {pathName: '/projects/delilah', isActive: hoverOption==='delilah', backgroundName: '/static/images/delilah/banner.jpg'},
      ...
      {pathName: '/projects/harvard', isActive: hoverOption==='harvard', backgroundName: '/static/images/harvard/image1.jpg'},
